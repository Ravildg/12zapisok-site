  ...
  games: [
    {
      ...
      tags: ["Мистика", "Детектив", "Убийца среди нас", "Ролевой квест", "Поиск подсказок", "У каждого своя цель", "Магический Египет", "Расследование", "Проклятая настольная игра", "Открытая концовка"],
    ...
    },
    {
      ...
      tags: ["Комедия", "Фантастика", "Исследование", "Крафтинг", "Состязание команд", "У каждого своя цель", "Ролевой квест", "Зоны активностей", "Неожиданные персонажи", "Элементы костюма каждому", "Открытая концовка"],
    ...
    },
    {
      ...
      tags: ["Гангстеры", "Казино", "Интриги", "Охота на сейфы", "Тир", "Аукцион",  "У каждого своя цель","Борьба за фишки", "Фотозона с пулеметом томпсона", "Элементы костюма каждому", "Открытая концовка"],
    ...
    },
    {
      ...
      tags: ["Стимпанк", "Головоломки", "Выйти из комнаты","Командная игра", "Мистическое средневековье", "Эффектные декорации", "Механические загадки", "Удивительные тайники", "4 тайные комнаты"],
    ...
    },
    {
      ...
      tags: ["Детектив", "Интриги", "Характерный отыгрыш", "1945 год", "У каждого своя цель", "Шпионские игры", "Открытая концовка"],
