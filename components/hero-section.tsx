...
const heroData = {
  ...
  description:
    "Квест-спектакли с ведущим и актёрами для взрослой компании. Каждый сюжет — как фильм, в котором вы главные герои. Проведите встречу, которую будут вспоминать.",
  image: "/uploads/pv10.jpg", // Фоновая картинка
};
