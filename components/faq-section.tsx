...
const faqs = [
  {
    ...
    answer:
      "И то, и другое. Это сюжетная игра с актёрами, в которую вы погружаетесь как участники. Вы не просто наблюдаете за происходящим, а активно влияете на развитие сюжета.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Нет, всё подготовим мы. Ваша задача — прийти и сыграть. Мы обеспечиваем полное погружение в атмосферу выбранного сюжета.",
  },
  {
