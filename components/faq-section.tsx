...
const faqs = [
  {
    ...
    answer:
      "И то, и другое. Это сюжетная игра с актёрами, в которую вы погружаетесь как участники. Вы не просто наблюдаете за происходящим, а активно влияете на развитие сюжета. Становитесь персонажем истории и действуете в предлагаемых обстоятельствах на актёрской импровизации всю игру.",
  },
  {
  ...
  {
    question: "Можно ли в квест-кафе организовать угощение после игры или во время?",
    answer:
