...
const faqs = [
  {
    ...
    answer:
      "И то, и другое. Это сюжетная игра с актёрами, в которую вы погружаетесь как участники. Вы не просто наблюдаете за происходящим, а активно влияете на развитие сюжета. Становитесь персонажем истории и впередлогаемых обстаятельствах действуете на актерской импровизации всю игру",
  },
  {
  ...
  },
  {
    ...
    answer:
      "В нашем пространстве в центре или на выезде, под запрос. Мы можем организовать квест-спектакль в удобном для вас месте, адаптировав сценарий под локацию.",
  },
  {
  ...
  {
    question: "Можно ли в квест-кафе организовать угощение, после игры или вовремя?",
    answer:
"Да, всё обговаривается. После игры мы сможем организовать столы и стулья в необходимом количестве. Некоторые игры допускают легкие закуски во время действа.У нас есть кулер с горячей и холодной водой, холодильник и микроволновка. Вы можете принести еду с собой или воспользоваться любой доставкой. Наш партнёр 'Додо Пицца' предоставляет скидку 15% для наших гостей по промокоду."
