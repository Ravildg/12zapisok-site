...
const reviews = [
  {
    ...
    name: "Анна К.",
    company: "HR",
    text: "Проводили в этом заведении корпоратив, остались очень довольны выбором.Выбрали гангстерскую вечеринку, т.к. хотелось чего-то нового. Было весело, костюмы-класс! Все получили задания, те, кто не очень-то хотел играть, нашли чем заняться в импровизированном казино. Очень атмосферно, внимательные ведущие, фотки - 🔥🔥 Так что придем ещё) ",
    rating: 5,
